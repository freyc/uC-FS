...
#include  "fs_dev_nand_ctrlr_file_soft_ecc.h"
...
#define  FS_NAND_CTRLR_MMAP_SOFT_ECC_CFG_FIELD(type, name, dflt_val)  dflt_val,
const  FS_NAND_CTRLR_MMAP_SOFT_ECC_CFG  FS_NAND_CtrlrMmap_SoftECC_DfltCfg = { FS_NAND_CTRLR_MMAP_SOFT_ECC_CFG_FIELDS };
#undef   FS_NAND_CTRLR_MMAP_SOFT_ECC_CFG_FIELD

SOFT_ECC_DATA  *FS_NAND_CtrlrMmap_SoftECC_ListFreePtr;
...
static  void             *Open      (FS_NAND_CTRLR_FILE_DATA  *p_ctrlr_data,
                                     void                    *p_ext_cfg,
                                     FS_ERR                  *p_err);

static  void              Close     (void                    *p_ext_data);

static  FS_NAND_PG_SIZE   Setup     (FS_NAND_CTRLR_FILE_DATA  *p_ctrlr_data,
                                     void                    *p_ext_data,
                                     FS_ERR                  *p_err);
...
FS_NAND_CTRLR_FILE_EXT  FS_NAND_CtrlrMmap_SoftECC =  {
    Init,                                                       /* Init().                                              */
    Open,                                                       /* Open().                                              */
    Close,                                                      /* Close().                                             */
    Setup,                                                      /* Setup().                                             */
...
static  void  Init (FS_ERR  *p_err)
{
    ...
    (void)p_err;
    CPU_CRITICAL_ENTER();
    FS_NAND_CtrlrMmap_SoftECC_ListFreePtr = DEF_NULL;
    CPU_CRITICAL_EXIT();
}
...
static  void  *Open (FS_NAND_CTRLR_FILE_DATA  *p_ctrlr_data,
                     ...
                     FS_ERR                  *p_err)
{
    FS_NAND_CTRLR_MMAP_SOFT_ECC_CFG  *p_soft_ecc_cfg;
    ...
    p_soft_ecc_cfg = (FS_NAND_CTRLR_MMAP_SOFT_ECC_CFG *)p_ext_cfg;
...
static  SOFT_ECC_DATA  *DataGet (void)
{
    ...
    CPU_SR_ALLOC();
                                                                ...
                                                                /* --------------------- ALLOC DATA ------------------- */
    CPU_CRITICAL_ENTER();
    if (FS_NAND_CtrlrMmap_SoftECC_ListFreePtr == (SOFT_ECC_DATA *)0) {
        ...
        p_soft_ecc_data                      = FS_NAND_CtrlrMmap_SoftECC_ListFreePtr;
        FS_NAND_CtrlrMmap_SoftECC_ListFreePtr = FS_NAND_CtrlrMmap_SoftECC_ListFreePtr->NextPtr;
    }
    CPU_CRITICAL_EXIT();
...
static  void  DataFree (SOFT_ECC_DATA  *p_ext_data)
{
    ...
    CPU_CRITICAL_ENTER();
                                                                /* Add to free pool.                                    */
    p_ext_data->NextPtr                  = FS_NAND_CtrlrMmap_SoftECC_ListFreePtr;
    FS_NAND_CtrlrMmap_SoftECC_ListFreePtr = p_ext_data;
    CPU_CRITICAL_EXIT();
}
